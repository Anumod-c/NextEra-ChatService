...
class RabbitMQClient{
    ...
    async initialize(){
        ...
        try{
            ...
            await this.produceChannel.assertQueue(RabbitMQconfig.rabbitMQ.queues.ChatQueue,{durable:true});
            await this.consumerChannel.assertQueue(RabbitMQconfig.rabbitMQ.queues.ChatQueue,{durable:true})
